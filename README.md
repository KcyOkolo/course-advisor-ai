...
4. Set Up API Key:
(email me at kyo3@duke.edu for access to my api key)
else-
...
Prompt A -first ever system prompt for  chat method of integrated_chat.py
...
Prompt B- final system prompt chat method of integrated_chat.py
